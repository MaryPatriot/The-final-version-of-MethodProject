...
namespace newerversion_of_method_project_1103
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Vehicle input from user, and validation of input data
            do
            {
            ...
            double[] timearray = new double[4]; //declare an array for user input times: hourenter,minenter, hourleft and minleft
            Inputtimes(timearray); //Call inputtime method
            double[] spenttimeArray = new double[3]; // declare an array for calculation of: hourspent, minspent and totalspenttime

            Spenttime(timearray, spenttimeArray); //Call spenttime method

            double vehicleCharge = VehicleCharge(Vehicle, spenttimeArray[2]); //call vehiclecharge method 
            ...
            {
                Outputformat(Vehicle, timearray, spenttimeArray[0], spenttimeArray[1], spenttimeArray[2], vehicleCharge); //Call outpuformat method
        ...
        // Method to calculate actual time spent in parking by vehicle. Using modulo arithmetic to handle time calculation.
